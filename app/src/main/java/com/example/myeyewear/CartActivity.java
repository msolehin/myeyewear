...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextProcessBtn=(Button) findViewById(R.id.btnPlaceOrder);
        txtTotalAmount=(TextView) findViewById(R.id.totalPrice);

        TextView empty=(TextView) findViewById(R.id.emptyCart);
        empty.setVisibility(TextView.INVISIBLE);
//        NextProcessBtn.setVisibility(Button.VISIBLE);

        final DatabaseReference RootRef3;
...
//                    NextProcessBtn.setVisibility(Button.INVISIBLE);
                ...
                RootRef2.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.child("Cart List").child("User View").child(Prevalent.currentOnlineUser.getPhone()).exists()) {
                            ...
                            //                ConfirmOrder();
                            txtTotalAmount.setText("RM "+String.valueOf(overTotalPrice));

                            Intent intent =new Intent(CartActivity.this,ConfirmFinalOrderActivity.class);
                            intent.putExtra("Total Price = RM ",String.valueOf(overTotalPrice));
                            startActivity(intent);
                            finish();

                        } else {
                            Toast.makeText(CartActivity.this, "Please add some products", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        back=(ImageButton) findViewById(R.id.btnBackC);
