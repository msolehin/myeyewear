...
public class AdminAddProduct extends AppCompatActivity {
    ...
    private String  Description, Price, Pname, Pcategory,  saveCurrentDate, saveCurrentTime;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        InputProductCategory = (EditText) findViewById(R.id.productCategory);
        InputProductDescription = (EditText) findViewById(R.id.productDetail);
    ...
    private void ValidateProductData()
    {
        ...
        Pcategory = InputProductCategory.getText().toString();
        ...
        ProductsRef.child(productRandomKey).updateChildren(productMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            Intent intent = new Intent(AdminAddProduct.this, AdminHome.class);
